...
> Oversized agent backlog for `jtgsystems/socialmedia`. This file intentionally contains 500 candidate roadmap items so bots always have something to pick up.
...
## Basis
- Repository description: Social media toolkit - Multi-platform management tools
- Detected stack: static site
- Profile guess: `automation-tool`
- Inferred stage: `growth`
- Key paths: `stylesheets/`
- Workflow files present: `ci.yml`, `dependabot-automerge.yml`
- Read-first signals: `CLAUDE.md`, `.github/workflows/`
...
- **Documentation, Onboarding, And Handoffs**: `AGENTS.md`, `CLAUDE.md`
